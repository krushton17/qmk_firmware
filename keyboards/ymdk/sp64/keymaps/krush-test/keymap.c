...
[_LAYER9] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_RMOD, RGB_MOD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, RGB_TOG, KC_NO, KC_NO, RGB_HUD, RGB_SAD, RGB_VAD),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(8, layer_state_cmp(state, _LAYER8));
    rgblight_set_layer_state(9, layer_state_cmp(state, _LAYER9));
    rgblight_set_layer_state(10, layer_state_cmp(state, _LAYER10));
    rgblight_set_layer_state(11, layer_state_cmp(state, _LAYER11));
    return state;
}
